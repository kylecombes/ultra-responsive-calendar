...
Import required React Bootstrap components within ```src/ultra-responsive-calendar.js``` file or your custom component files:
...
4. Add `// @flow` to any files you want to type check (for example, to `src/ultra-responsive-calendar.js`).
